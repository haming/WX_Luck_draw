 ...
 * 奖品数量处理
 */
exports.gifts_manager = function(gift_number,id ,callback){
    CRUD._update(dbconf.client,"update gifts  set gift_Number = ? where id = ?",[gift_number,id],function(err,result){
        callback(err,result);
    });
}